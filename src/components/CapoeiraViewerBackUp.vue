<template>
    <div class="viewer-container">
        ...
        <button @click="triggerAnimation('Waving')">Waving</button>
...
<script setup>
  ...
  const CHARACTER_MODEL_FILE = new URL('../assets/models/model.fbx', import.meta.url).href; // Your main character model
